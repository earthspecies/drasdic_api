"""
Evaluation script
Slightly modified from https://github.com/c4dm/dcase-few-shot-bioacoustic/blob/main/evaluation_metrics/evaluation.py
Under MIT License
"""
...
import numpy as np
import csv
from drasdic.evaluation import dcase_metrics as metrics
